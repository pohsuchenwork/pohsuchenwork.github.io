  ...
  "apps": {
    ...
    works: [
      ...
      },
      {
        ...
        disclaimer: "Pokémon® is a trademark of Nintendo, Creatures Inc., and Game Freak Inc. This is a fan-made tribute and is not commissioned by, affiliated with, or endorsed by them."
      },
      {
        ...
        description: "A full-stack AI code explainer running a Llama model on Vercel, streamed to the browser and rate-limited and cached with Redis for a fast, privacy-minded experience. Click the thumbnail to watch the demo on YouTube."
      },
      {
      ...
      },
      {
        ...
        disclaimer: "The AK-74 and M1911 are historical service weapons whose original design patents have long expired. This prototype is not commissioned by, affiliated with, or endorsed by any current arms manufacturer. YouTube® is a trademark of Google LLC; this page is not affiliated with or endorsed by Google LLC."
      }
    ]
  },
  "websites": {
    ...
    works: [
      ...
      },
      {
        ...
        disclaimer: "Zorin OS and its desktop are the work of Zorin Technologies Limited. This is a pastiche and is not commissioned by, affiliated with, or endorsed by them."
      },
      {
      ...
      },
      {
        ...
        client: "Savepoint (my own venture)",
        externalUrl: "https://savepoint-signup.vercel.app",
        ...
        disclaimer: "Startmate Ventures Pty Ltd is named only as the programme the work was taken through, not as a backer, investor, or endorser."
      },
      {
  ...
  "posters": {
    ...
    works: [
      ...
      },
      {
        ...
        tagline: "A speculative launch poster for a Red Bull flavour that does not exist.",
        client: "Self-directed",
        description: 'Speculative product launch poster for a fictional Red Bull "Blue Edition" blueberry flavour. Personal exploration of beverage advertising with splash photography and ingredient styling.',
      ...
      },
      {
        ...
        tagline: "A speculative launch poster for a Starbucks Kiwi Frappuccino that does not exist.",
        client: "Self-directed",
        description: "Speculative product launch poster for a fictional Starbucks Kiwi Frappuccino. Personal exploration of beverage advertising with motion-frozen imagery and ingredient styling.",
        disclaimer: "Starbucks® and the Starbucks logo are trademarks of Starbucks Corporation. This poster is not commissioned by, affiliated with, or endorsed by Starbucks Corporation."
      },
      {
      ...
      },
      {
        ...
        disclaimer: "Gojo Satoru, Jujutsu Kaisen, and related characters are copyrighted by Gege Akutami, Shueisha, and MAPPA. This poster is not commissioned by, affiliated with, or endorsed by the rights holders."
      },
      {
        ...
        disclaimer: "The M1 Garand is a historical WWII-era service rifle whose original design patents have long expired. This poster is not commissioned by, affiliated with, or endorsed by Springfield Armory Inc. or any current manufacturer of historical-pattern rifles."
      },
      {
        src: "images/visionary-art-comp.jpg?v=dff1d6f6",
        width: 1358,
        height: 1920,
        title: "Visionary Art Competition Poster",
        tagline: "The promotional poster for an art competition I organised and livestreamed.",
        client: "Lycoris Inc.",
        description: "Promotional poster for the Visionary Art Competition, an event I organised and livestreamed under Lycoris Inc. Distributed across the event's channels and digital displays."
      },
      {
        src: "images/lycoris-logo.png?v=67150cfc",
        width: 1920,
        height: 1920,
        title: "Lycoris Inc. Logo",
        tagline: "The brand mark for Lycoris Inc.",
        client: "Lycoris Inc.",
        description: "Brand logo for Lycoris Inc. Designed for a distinctive, energetic identity."
      }
    ]
  },
  "archive": {
    ...
    works: [
      ...
      },
      {
        ...
        client: "Savepoint (my own venture)",
        externalUrl: "https://savepoint-signup.vercel.app",
        description: "The Savepoint app, an AI vibe coding saving tool for snapshotting code generated through AI sessions. Click the thumbnail to open the signup site in a new tab."
      },
      {
      ...
      },
      {
        ...
        disclaimer: "Tetris® is a trademark of The Tetris Company LLC. Chrome™ and the Chrome Web Store™ are trademarks of Google LLC. This extension is not commissioned by, affiliated with, or endorsed by The Tetris Company LLC or Google LLC."
      },
      {
        src: "images/nand-to-tetris-cert.jpg?v=93d121fb",
        width: 1600,
      ...
      },
      {
        ...
        disclaimer: "F1 in Schools is an educational programme operated by the F1 in Schools Foundation. Formula 1® and F1® are trademarks of Formula One World Championship Limited. This work documents my team's participation in the programme and is not commissioned by, affiliated with, or endorsed by the F1 in Schools Foundation or Formula One World Championship Limited."
      },
      {
        ...
        disclaimer: "F1 in Schools is an educational programme operated by the F1 in Schools Foundation. Formula 1® and F1® are trademarks of Formula One World Championship Limited. Fusion 360® is a trademark of Autodesk Inc. This work documents my team's participation in F1 in Schools and is not commissioned by, affiliated with, or endorsed by the F1 in Schools Foundation, Formula One World Championship Limited, or Autodesk Inc."
      },
      {
...
function buildPicker() {
  CATEGORY_ORDER.forEach((key, i) => {
    ...
    const coverImg = webpCover ? `<picture>
           <source srcset="${webpCover}" type="image/webp">
           <img src="${cat.cover}" alt=""
                loading="lazy" decoding="async"
                width="${cw}" height="${ch}" />
         </picture>` : `<img src="${cat.cover}" alt=""
              loading="lazy" decoding="async"
    ...
    button.innerHTML = `
      ...
      <div class="picker__foot">
        <span class="picker__name">${cat.label}</span>
  ...
  $picker.addEventListener("keydown", (e) => {
    ...
    selectCategory(tabs[j].dataset.category);
  });
  updateActive();
}
...
function buildWorks(works) {
  ...
  works.forEach((work, i) => {
    ...
    article.dataset.workClient = work.client;
    const metaText = work.client;
    ...
    const imgHtml = webpSrc ? `<picture>
           <source srcset="${webpSet}" ${sizesAttr} type="image/webp">
           <img src="${work.src}" alt="${altText}"
                loading="lazy" decoding="async" ${dimAttrs} />
         </picture>` : `<img src="${work.src}" alt="${altText}"
              loading="lazy" decoding="async" ${dimAttrs} />`;
    ...
    article.innerHTML = `
      ...
      <div class="work__caption">
        <div class="work__num">N&deg; ${num}</div>
...
function updateWorksHead(key) {
  ...
  if (status) status.textContent = `${cat.label}, ${cat.works.length} works`;
}
...
function initLightbox() {
  ...
  const triggerLightbox = (media) => {
    ...
    const info = article ? {
      ...
      client: article.dataset.workClient,
